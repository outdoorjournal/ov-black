...
_RUBRIC_BASE = (
    ...
    "3. The party — just them? New companions? People already in their "
    "party? Check ``party_members`` in your context first; reconcile new "
    "detail onto an existing member with ``update_party_member``, and only "
    "``record_party_member`` for a genuinely new person.\n"
