...
RENDERING_NOTE = (
    ...
    "it shows. ``present_route`` only *previews* a journey — it writes nothing "
    "to the plan; to actually put a car on the trip, that is ``add_transfer`` "
    "(see the planning tools).\n"
