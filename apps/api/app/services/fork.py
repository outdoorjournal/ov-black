...
async def fork_itinerary(
    ...
    *,
    ...
    fork = Itinerary(
        ...
        # Carry campaign provenance + chat mood + hero image onto the working
        # copy so the agent stays campaign-aware and the dashboard hero/kickoff
        # still fire when intake runs on the fork (0047, 0054).
