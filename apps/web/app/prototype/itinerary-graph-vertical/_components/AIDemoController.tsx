...
export function AIDemoController({ onRun, disabled = false }: AIDemoControllerProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <span className="text-[10px] uppercase tracking-[0.22em] text-ink/55">Demo AI</span>
      <DemoButton
        label="Propose cards"
  ...
  return (
    <button
      ...
      className={[
        ...
        running ? "border-ink/60 bg-ink text-paper" : "border-ink/20 bg-paper text-ink/75 hover:bg-ink/5",
